...
\vspace{1cm}
\large Εγκρίθηκε από την τριμελή εξεταστική επιτροπή την 25η Ιουνίου 2026.\\
\begin{center}
    \small
    \begin{tabular}{p{0.3\textwidth} p{0.3\textwidth} p{0.3\textwidth}}
        
        \centering \dotfill & \centering \dotfill & \centering \dotfill \tabularnewline
        \centering \mySupervisor & \centering \mySupervisortwo & \centering \mySupervisorthree \tabularnewline
        \centering \mySupervisorTitle & \centering \mySupervisorTitletwo & \centering \mySupervisorTitlethree \tabularnewline
    \end{tabular}
\end{center}

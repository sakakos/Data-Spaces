%ΠΡΟΣΩΠΙΚΑ ΣΤΟΙΧΕΙΑ
\newcommand{\myAuthor}{Κάκος Σωτήριος}
\newcommand{\TitleGR}{Περιβάλλον πειραματισμού με \textlatin{Data-Spaces} με χρήση \textlatin{FIWARE} και \textlatin{i4Trust}}

%ΣΥΜΠΛΗΡΩΣΤΕ ΓΙΑ ΤΟΥΣ ΥΠΟΛΟΙΠΟΥΣ ΕΠΙΒΛΕΠΟΝΤΕΣ/ΕΞΕΤΑΣΤΙΚΗ ΕΠΙΤΡΟΠΗ
\newcommand{\mySupervisor}{Ευστάθιος Δ. Συκάς}
\newcommand{\mySupervisorTitle}{Ομότ. Καθηγητής, ΕΜΠ}

\newcommand{\mySupervisortwo}{Ν. Μήτρου}
\newcommand{\mySupervisorTitletwo}{Ομότ. Καθηγητής, ΕΜΠ}

\newcommand{\mySupervisorthree}{Ι. Ρουσσάκη}
\newcommand{\mySupervisorTitlethree}{Αν. Καθηγήτρια, ΕΜΠ}

\newcommand{\myDate}{Αθήνα, Ιούνιος 2026}
\newcommand{\myLab}{Τομέας Επικοινωνιών, Ηλεκτρονικής & Συστημάτων Πληροφορικής}
...
% Απαγόρευση συλλαβισμού και αποκοπής λέξεων
\hyphenpenalty=10000
\exhyphenpenalty=10000

% Επιτρέπει στο LaTeX να μεγαλώσει τα κενά μεταξύ των λέξεων
\sloppy
...
\addto\captionsgreek{%
  ...
  \renewcommand{\appendixname}{Βιβλιογραφία}%
}

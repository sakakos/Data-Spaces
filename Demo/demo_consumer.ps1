...
$KONG_BASE     = "http://127.0.0.1:8000/ngsi-ld/v1/entities"
$KEYROCK_URL   = "http://127.0.0.1:3007/oauth2/token"
...
Write-Host "============================================================"
Write-Host " Data Space Demo Consumer"
Write-Host "============================================================"
...
Write-Host "  Βήμα 2/3: Λήψη access token από το Keyrock"
